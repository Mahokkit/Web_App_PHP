...
//    public function commitInsertAction($ActorID,$fName,$lName,$lastUpdate)
    public function commitInsertAction($first_name, $last_name)
    {
        $lastUpdateResults = "";

        $lastUpdateResults = $this->Model->InsertActorData($first_name, $last_name);
